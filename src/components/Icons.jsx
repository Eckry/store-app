...
export function ShoppingCartIconRed() {
  return (
    <svg
      fill="yellow"
      height="40"
    ...
    >
      ...
      <path
        ...
        fill="rgba(255, 0, 0, 0.225)"
      />
      <path d="M 6.5 4.5 L 10.5 9" stroke="red" />
      <path d="M 10.5 4.5 L 6.5 9" stroke="red" />
      <circle cx="6.5" cy="4.5" r="0.47" fill="red" />
      <circle cx="10.5" cy="9" r="0.47" fill="red" />
      <circle cx="10.5" cy="4.5" r="0.47" fill="red" />
      <circle cx="6.5" cy="9" r="0.47" fill="red" />
    </svg>
  );
}